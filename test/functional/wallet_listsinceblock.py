...
class ListSinceBlockTest (TheBurningSavageTestFramework):
    ...
    def test_double_spend(self):
        ...
        1. User 1 receives TBS in tx1 from utxo1 in block aa1.
        2. User 2 receives TBS in tx2 from utxo1 (same) in block bb1
