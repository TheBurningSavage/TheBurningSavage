...
"""Verify that starting theburningsavage with -h works as expected."""

from test_framework.test_framework import TheBurningSavageTestFramework
from test_framework.util import assert_equal

class HelpTest(TheBurningSavageTestFramework):
    ...
    def run_test(self):
        self.log.info("Start theburningsavage with -h for help text")
        ...
        self.log.info("Start theburningsavage with -version for version information")
        ...
        self.log.info("Start theburningsavaged with -fakearg to make sure it does not start")
