...
# TestP2PConn: A peer we use to send messages to theburningsavaged, and store responses.
...
class CompactBlocksTest(TheBurningSavageTestFramework):
    ...
    # This test actually causes theburningsavaged to (reasonably!) disconnect us, so do this last.
    ...
    # theburningsavaged's choice of nonce.
    ...
    # Test that theburningsavaged requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for theburningsavaged to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # theburningsavaged will not send blocktxn responses for blocks whose height is
