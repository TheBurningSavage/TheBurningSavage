# Support for Output Descriptors in TheBurningSavage Core

Since TheBurningSavage Core v0.17, there is support for Output Descriptors in the
...
- [WIF](https://en.theburningsavage.it/wiki/Wallet_import_format) encoded private keys may be specified instead of the corresponding public key, with the same meaning.
-`xpub` encoded extended public key or `xprv` encoded private key (as defined in [BIP 32](https://github.com/theburningsavage/bips/blob/master/bip-0032.mediawiki)).
...
- P2SH addresses (base58, of the form `3...`, defined in [BIP 13](https://github.com/theburningsavage/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `bc1...`, defined in [BIP 173](https://github.com/theburningsavage/bips/blob/master/bip-0173.mediawiki)).
...
on TheBurningSavage's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing TheBurningSavage Core wallets, a convenience function `combo` is
