TheBurningSavage-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/theburningsavage/files/TheBurningSavage/theburningsavage-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the TheBurningSavage
...
New/changed settings (command-line or theburningsavage.conf file)
--------------------------------------------------------
