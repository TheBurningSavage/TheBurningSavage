TheBurningSavage Core version 0.9.2.1 is now available from:

  https://theburningsavage.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TBS to 0.01 TBS
...
- Fix "Start theburningsavage on system login"
