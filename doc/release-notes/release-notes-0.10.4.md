TheBurningSavage Core version 0.10.4 is now available from:

  <https://theburningsavage.org/bin/theburningsavage-core-0.10.4/>
...
- #6953 `43c2789` Split theburningsavage-tx into its own package
- #6953 `dfe0d4d` Include theburningsavage-tx binary on Debian/Ubuntu
