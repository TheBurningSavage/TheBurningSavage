TheBurningSavage Core version 0.13.2 is now available from:

  <https://theburningsavage.org/bin/theburningsavage-core-0.13.2/>
...
- #8908 `4a974b2` Update theburningsavage-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow theburningsavage-tx to create v2 transactions (btcdrak)
