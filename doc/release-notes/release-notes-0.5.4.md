TheBurningSavage version 0.5.4 is now available for download at:
http://sourceforge.net/projects/theburningsavage/files/TheBurningSavage/theburningsavage-0.5.4/
...
http://gitorious.org/theburningsavage/theburningsavaged-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix TheBurningSavage-Qt notifications under Growl 1.3.
Increase required age of TheBurningSavage-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTheBurningSavage properly when installing TheBurningSavage-Qt over it. (Windows)
