TheBurningSavage Core version 0.9.4 is now available from:

  https://theburningsavage.org/bin/0.9.4/
...
this update is incompatible with the TheBurningSavage system and could lead to consensus
forks.

TheBurningSavage Core released binaries from https://theburningsavage.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~theburningsavage/+archive/ubuntu/theburningsavage
- A third-party or self-compiled TheBurningSavage Core

upgrade to TheBurningSavage Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
