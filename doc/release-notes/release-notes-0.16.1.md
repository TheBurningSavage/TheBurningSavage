TheBurningSavage Core version 0.16.1 is now available from:

  <https://theburningsavagecore.org/bin/theburningsavage-core-0.16.1/>
...
- #12843 `df38b13` Test starting theburningsavaged with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure theburningsavaged processes are cleaned up when tests end (sdaftuar)
