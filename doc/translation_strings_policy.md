...
This document provides guidelines for internationalization of the TheBurningSavage Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `theburningsavage_en.ts` remains unchanged.
