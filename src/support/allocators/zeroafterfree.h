...
#ifndef THEBURNINGSAVAGE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define THEBURNINGSAVAGE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // THEBURNINGSAVAGE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
