...
#ifndef THEBURNINGSAVAGE_QT_SENDCOINSDIALOG_H
#define THEBURNINGSAVAGE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending theburningsavages */
...
#endif // THEBURNINGSAVAGE_QT_SENDCOINSDIALOG_H
