    ...
    mapper(0)
{
    ...
    ui->theburningsavageAtStartup->setToolTip(ui->theburningsavageAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->theburningsavageAtStartup->setText(ui->theburningsavageAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTheBurningSavageConfButton->setToolTip(ui->openTheBurningSavageConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TheBurningSavageUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->theburningsavageAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTheBurningSavageConfButton_clicked()
{
    ...
    if (!GUIUtil::openTheBurningSavageConf())
