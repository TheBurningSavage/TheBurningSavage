...
#ifndef THEBURNINGSAVAGE_QT_TEST_PAYMENTSERVERTESTS_H
#define THEBURNINGSAVAGE_QT_TEST_PAYMENTSERVERTESTS_H
...
#endif // THEBURNINGSAVAGE_QT_TEST_PAYMENTSERVERTESTS_H
