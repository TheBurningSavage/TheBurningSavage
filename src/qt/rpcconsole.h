...
#ifndef THEBURNINGSAVAGE_QT_RPCCONSOLE_H
#define THEBURNINGSAVAGE_QT_RPCCONSOLE_H
...
/** Local TheBurningSavage RPC console. */
...
#endif // THEBURNINGSAVAGE_QT_RPCCONSOLE_H
