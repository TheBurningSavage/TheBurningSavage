    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return TheBurningSavageUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, TheBurningSavageUnits::separatorNever);
            else
                return TheBurningSavageUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+TheBurningSavageUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
