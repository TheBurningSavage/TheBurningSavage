...
#ifndef THEBURNINGSAVAGE_QT_THEBURNINGSAVAGEUNITS_H
#define THEBURNINGSAVAGE_QT_THEBURNINGSAVAGEUNITS_H
...
/** TheBurningSavage unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TheBurningSavageUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TheBurningSavageUnits(QObject *parent);

    /** TheBurningSavage units.
      @note Source: https://en.theburningsavage.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TBS,
...
typedef TheBurningSavageUnits::Unit TheBurningSavageUnit;

#endif // THEBURNINGSAVAGE_QT_THEBURNINGSAVAGEUNITS_H
