...
#ifndef THEBURNINGSAVAGE_QT_SPLASHSCREEN_H
#define THEBURNINGSAVAGE_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. TheBurningSavage Core initialization
...
#endif // THEBURNINGSAVAGE_QT_SPLASHSCREEN_H
