...
#ifndef THEBURNINGSAVAGE_QT_WALLETMODEL_H
#define THEBURNINGSAVAGE_QT_WALLETMODEL_H
...
/** Interface to TheBurningSavage wallet from Qt view code. */
...
#endif // THEBURNINGSAVAGE_QT_WALLETMODEL_H
