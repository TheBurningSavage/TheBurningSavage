...
#ifndef THEBURNINGSAVAGE_WALLET_WALLET_H
#define THEBURNINGSAVAGE_WALLET_WALLET_H
...
public:
     ...
     * on this theburningsavage node, and set to 0 for transactions that were created
...
#endif // THEBURNINGSAVAGE_WALLET_WALLET_H
