...
#ifndef THEBURNINGSAVAGE_INTERFACES_NODE_H
#define THEBURNINGSAVAGE_INTERFACES_NODE_H
...
//! Top-level interface for a theburningsavage node (theburningsavaged process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // THEBURNINGSAVAGE_INTERFACES_NODE_H
