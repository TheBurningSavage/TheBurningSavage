...
static void SetupTheBurningSavageTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " theburningsavage-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  theburningsavage-tx [options] <hex-tx> [commands]  Update hex-encoded theburningsavage transaction\n" +
            "or:     theburningsavage-tx [options] -create [commands]   Create hex-encoded theburningsavage transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded theburningsavage transaction
