...
{
    RenameThread("theburningsavage-http");
...
{
    RenameThread("theburningsavage-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/theburningsavage/theburningsavage/pull/6990)
