...
{
    BOOST_CHECK(TestSplitHost("www.theburningsavagecore.org", "www.theburningsavagecore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.theburningsavagecore.org]", "www.theburningsavagecore.org", -1));
    BOOST_CHECK(TestSplitHost("www.theburningsavagecore.org:80", "www.theburningsavagecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.theburningsavagecore.org]:80", "www.theburningsavagecore.org", 80));
