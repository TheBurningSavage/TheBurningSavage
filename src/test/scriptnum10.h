...
#ifndef THEBURNINGSAVAGE_TEST_SCRIPTNUM10_H
#define THEBURNINGSAVAGE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from TheBurningSavage Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // THEBURNINGSAVAGE_TEST_BIGNUM_H
