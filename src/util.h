 ...
 */
#ifndef THEBURNINGSAVAGE_UTIL_H
#define THEBURNINGSAVAGE_UTIL_H
...
extern const char * const THEBURNINGSAVAGE_CONF_FILENAME;
extern const char * const THEBURNINGSAVAGE_PID_FILENAME;
...
{
    std::string s = strprintf("theburningsavage-%s", name);
